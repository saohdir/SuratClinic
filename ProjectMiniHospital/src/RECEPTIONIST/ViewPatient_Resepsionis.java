 ...
 * @author surap
 */
public class ViewPatient_Resepsionis extends javax.swing.JFrame {
     ...
     */
    public ViewPatient_Resepsionis() {
        initComponents();
        loadtable();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ViewPatient_Resepsionis.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ViewPatient_Resepsionis().setVisible(true);
            }
        });
    }
