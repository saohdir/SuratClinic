...
import DB.Connector;
import static RECEPTIONIST.ViewReceptionist.sql;
...
public class ViewAppointment extends javax.swing.JFrame {
    ...
    /**
     * Creates new form ViewAppointmenr
     */
    public ViewAppointment() {
        initComponents();
        loadtable();
        jPanel1.setFocusable(true);
        tblPerjanjian.getTableHeader().setDefaultRenderer(new HeaderColor());
    ...
    private void initComponents() {
        ...
        tblPerjanjian = new javax.swing.JTable();
        ...
        tblPerjanjian.setFont(new java.awt.Font("Dialog", 0, 14)); // NOI18N
        tblPerjanjian.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {

            },
            new String [] {
                "dName", "pName", "Ruangan", "Tanggal"
            }
        ) {
        ...
        tblPerjanjian.setEnabled(false);
        tblPerjanjian.setRowHeight(25);
        tblPerjanjian.getTableHeader().setResizingAllowed(false);
        tblPerjanjian.getTableHeader().setReorderingAllowed(false);
        jScrollPane1.setViewportView(tblPerjanjian);
        if (tblPerjanjian.getColumnModel().getColumnCount() > 0) {
            tblPerjanjian.getColumnModel().getColumn(0).setResizable(false);
            tblPerjanjian.getColumnModel().getColumn(1).setResizable(false);
            tblPerjanjian.getColumnModel().getColumn(2).setResizable(false);
            tblPerjanjian.getColumnModel().getColumn(3).setResizable(false);
        }
        ...
        jLabel10.setText("Data Perjanjian");
    ...
    static public class HeaderColor extends DefaultTableCellRenderer{
        public HeaderColor(){
                setOpaque(true);
    }public Component getTableCellRendererComponent(JTable tblPerjanjian, Object value, boolean selected, boolean focused, int row, int column){
        super.getTableCellRendererComponent(tblPerjanjian,value,selected,focused,row,column);
    ...
    private void txtcariKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtcariKeyReleased
        try {
            DefaultTableModel table = (DefaultTableModel) tblPerjanjian.getModel();
            String search = txtcari.getText().toString();
            TableRowSorter<DefaultTableModel> tr = new TableRowSorter<DefaultTableModel>(table);
            tblPerjanjian.setRowSorter(tr);
    ...
    private javax.swing.JTable tblPerjanjian;
    private javax.swing.JTextField txtcari;
    // End of variables declaration//GEN-END:variables

    private void loadtable() {
        DefaultTableModel dtm = (DefaultTableModel) tblPerjanjian.getModel();

        connection = Connector.ConnectDb();
        try {
            sql = "select dName,pName,Ruangan,Tanggal from tbl_perjanjian";
