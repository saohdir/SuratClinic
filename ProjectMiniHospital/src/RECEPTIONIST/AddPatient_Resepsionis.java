 ...
 * @author surap
 */
public class AddPatient_Resepsionis extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AddPatient_Resepsionis.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AddPatient_Resepsionis().setVisible(true);
            }
        });
    }
