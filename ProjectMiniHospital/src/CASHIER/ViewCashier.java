...
tblKasir.getTableHeader().setDefaultRenderer(new HeaderColor());
    ...
    private void initComponents() {
        ...
        tblKasir.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Tanggal", "id_kasir", "Nama_Kasir", "Usia", "Jenis_Kelamin", "Email", "Nomor_Telepon", "Alamat", "username", "password"
            }
        ));
        tblKasir.setEnabled(false);
    ...
    private void txtcariKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtcariKeyReleased
        try {
            DefaultTableModel table = (DefaultTableModel) tblKasir.getModel();
            String search = txtcari.getText().toString();
            TableRowSorter<DefaultTableModel> tr = new TableRowSorter<DefaultTableModel>(table);
            tblKasir.setRowSorter(tr);
    ...
    private void loadtable() {
        ...
        try {
            sql = "select Tanggal,id_kasir,Nama_Kasir,Usia,Jenis_Kelamin,Email,Nomor_Telepon,Alamat,username,password from tbl_kasir";
