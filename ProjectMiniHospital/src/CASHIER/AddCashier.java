...
public class AddCashier extends javax.swing.JFrame {
    ...
    static ResultSet rs;
    static Statement st;
    static String sql, uId, uName, pass, email, password, username, addrs, gender, dob, usia, phone;
    ...
    private void initComponents() {
        ...
        jPanel1.add(txtidkasir, new org.netbeans.lib.awtextra.AbsoluteConstraints(400, 180, 223, 40));

        txtnamakasir.setFont(new java.awt.Font("Verdana", 0, 18)); // NOI18N
        jPanel1.add(txtnamakasir, new org.netbeans.lib.awtextra.AbsoluteConstraints(400, 250, 223, 40));
        ...
        jPanel1.add(jDateChooser, new org.netbeans.lib.awtextra.AbsoluteConstraints(1120, 170, 220, 30));
 ...
 private void getfield() {
    ...
    private void addresepsionis() {
        ...
        if (!regexMatcher.matches()) {
            JOptionPane.showMessageDialog(null, "Email Bermasalah", "Warning",JOptionPane.WARNING_MESSAGE);
            ...
            try {
                sql = "INSERT INTO tbl_kasir(Tanggal,id_kasir,Nama_Kasir,Usia,Jenis_Kelamin,Email,Nomor_Telepon,Alamat,username,password) VALUES (?, ?, ?, ?, ?, ?, ?, ?,?,?)";
