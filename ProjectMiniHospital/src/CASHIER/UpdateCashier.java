...
public class UpdateCashier extends javax.swing.JFrame {
    ...
    static String sql, uId, uName, email, username, password, addrs, gender, dob, usia, phone;
    ...
    public UpdateCashier() {
        initComponents();
        Object columns[] = {"Count", "Tanggal", "id_kasir", "Nama_Kasir", "Usia", "Jenis_Kelamin", "Email", "Nomor_Telepon", "Alamat", "username", "password"};
        defaultTableModel.setColumnIdentifiers(columns);
        tblKasir.setModel(defaultTableModel);
    ...
    private void initComponents() {
        ...
        txtidkasir.setFont(new java.awt.Font("Verdana", 0, 18)); // NOI18N
        txtidkasir.setDisabledTextColor(new java.awt.Color(255, 0, 0));
        jPanel1.add(txtidkasir, new org.netbeans.lib.awtextra.AbsoluteConstraints(260, 150, 189, 40));

        txtnamakasir.setFont(new java.awt.Font("Verdana", 0, 18)); // NOI18N
        jPanel1.add(txtnamakasir, new org.netbeans.lib.awtextra.AbsoluteConstraints(260, 220, 189, 40));
        ...
        jPanel1.add(jDateChooser, new org.netbeans.lib.awtextra.AbsoluteConstraints(740, 400, 230, 40));
    ...
    private void btnubahActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnubahActionPerformed
        ...
        if (ops == JOptionPane.YES_OPTION) {
            if (txtalamat.getText().equals("") || txtnamakasir.getText().equals("")
            ...
            if (!regexMatcher.matches()) {
                ...
                try {
                    sql = "UPDATE tbl_kasir SET Tanggal = ?, Nama_Kasir = ?, Usia = ?,Jenis_Kelamin = ?, Email = ?, Nomor_Telepon = ?,Alamat = ?,username = ?,password = ? WHERE Id_kasir = ?";
    ...
    private void tblKasirMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblKasirMouseClicked
        ...
        txtidkasir.setText(model.getValueAt(i, 2).toString());
        txtnamakasir.setText(model.getValueAt(i, 3).toString());
    ...
    private void btncariActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btncariActionPerformed
        ...
        try {
            flag = 0;
            sql = "select Count,Tanggal,id_kasir,Nama_Kasir,Usia,Jenis_Kelamin,Email,Nomor_Telepon,Alamat,username,password from tbl_kasir where Nama_Kasir = '" + search + "'";
            ...
            while (rs.next()) {
                ...
                columnData[2] = rs.getString("id_kasir");
                columnData[3] = rs.getString("Nama_Kasir");
            ...
            JOptionPane.showMessageDialog(null, "Data Kasir TIdak Ditemukan");
        }
 ...
 private void loadtable() {
    ...
    private void getfield() {
        ...
        uId = txtidkasir.getText();
        uName = txtnamakasir.getText();
