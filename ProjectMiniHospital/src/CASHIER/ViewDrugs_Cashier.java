 ...
 * @author surap
 */
public class ViewDrugs_Cashier extends javax.swing.JFrame {
...
tblObat.getTableHeader().setDefaultRenderer(new HeaderColor());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ViewDrugs_Cashier.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ViewDrugs_Cashier().setVisible(true);
            }
        });
    }
